                            ...
                            <div class="col-12 col-md-6">
                                ...
                                <div class="mb-3">
                                    ...
                                    <div class="imageContent">
                                        <img id="imageContent" src="@if (isset($blog) && !empty($blog->image)){{asset('storage/blogs/' . basename($blog->image))}}@else{{asset('library/admin/default-image.png')}}@endif" alt="Image preview" style="max-width: 100%; max-height: 150px;">
                                    </div>
                                </div>
                            </div>
