                ...
                <tbody>
                    ...
                    @foreach ($sliders as $key => $slider)
                        <tr>
                            ...
                            <td valign="middle">
                                <img src="@if (!empty($slider->image)){{asset('storage/sliders/' . basename($slider->image))}}@else{{asset('library/admin/default-image.png')}}@endif" alt="{{$slider->name}}" style="max-width: 100%; max-height: 200px;">
                            </td>
